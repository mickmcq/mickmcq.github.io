...
## Coding with Cursor
- I suggest you take advantage of Cursor's free year for students on the Pro tier. (You have to supply your ID to get it.)
...
## Next app on Cursor
- The main reason I wanted to try Cursor was that it has a panel that resembles a Figma panel (shown in the next frame).
...
- By the way, Cursor doesn't know it has a CSS Inspector, so you just have to find it yourself as of January 2026!

## Cursor display with CSS inspector in Design mode
![](fiCursorInDesignMode.png)

## Claude Code + Figma
- Figma has a thing called an MCP server (Model Context Protocol), a defacto standardized bridge between models (I'm using it with Claude Code and the Sonnet 4.5 model) and tools (Figma, in this case).
