...
- Good work overall
- Not everyone followed all the instructions
- One exemplary report inspired me to try an exercise
- I want you to try that exercise now
- Go to Files > hw > claudeCodeAccessibilityExample
- Download `claudeCodeGroundTruth.pdf`, the exemplary report
- Download `claudeCodeReport.pdf`, a report done by Claude Code
- Spend twenty minutes comparing them side by side on your screen
- Use the first five minutes to skim, then spend five minutes per page for three pages

## Crazy Eights
![](fiCrazyEights.png)

## Mood Boards
![](fiMoodBoardWilliam.png)
...
[https://youtu.be/HcLz3ikw-n0?si=MVPkFz-53AHIc7p4](https://youtu.be/HcLz3ikw-n0?si=MVPkFz-53AHIc7p4) is a discussion with Kyle Zantos about design tools using Claude, Cursor, and more. I urge you to watch it.
...
![](fiKyleZantosScreen.png)

## Kyle Zantos recommends ...
- Jhey Tompkins: [https://x.com/jh3yy](https://x.com/jh3yy)
- Derek Briggs: [https://x.com/PixelJanitor](https://x.com/PixelJanitor)
- Will King: [https://x.com/willking](https://x.com/willking)
- Emil Kowalski: [https://x.com/emilkowalski](https://x.com/emilkowalski)
- Jakub Krehel:  [https://jakub.kr/](https://jakub.kr/)
- Leva control panel: [https://threejsresources.com/tool/leva](https://threejsresources.com/tool/leva)
- Compound Engineering plugin: [https://github.com/EveryInc/compound-engineering-plugin](https://github.com/EveryInc/compound-engineering-plugin)


## Coding with Cursor
- I suggest you take advantage of Cursor's free year for students on the Pro tier. (You have to supply your ID to get it. Visit [https://cursor.com/students](https://cursor.com/students))
...
## Next app on Cursor
- The main reason I wanted to try Cursor was that it has a panel that resembles a Figma panel (shown in the next frame). Described at [https://cursor.com/blog/browser-visual-editor](https://cursor.com/blog/browser-visual-editor) and [https://cursor.com/docs/agent/browser](https://cursor.com/docs/agent/browser)
...
![](fiCursorInDesignMode.png)

## Using shadow instead of border with Cursor
![](fiShadowVsBorder.png)

I instructed Cursor to look at [https://jakub.kr/work/shadows](https://jakub.kr/work/shadows) and to use that in the Tip Calculator

## Claude Code + Figma
- Figma has a thing called an MCP server (Model Context Protocol), a defacto standardized bridge between models (I'm using it with Claude Code and the Sonnet 4.5 model) and tools (Figma, in this case). Visit [https://help.figma.com/hc/en-us/articles/32132100833559-Guide-to-the-Figma-MCP-server](https://help.figma.com/hc/en-us/articles/32132100833559-Guide-to-the-Figma-MCP-server)
...
[https://youtu.be/1-x-QzNjFHQ?si=rnSDiik-qsmVKYmf](https://youtu.be/1-x-QzNjFHQ?si=rnSDiik-qsmVKYmf) is an interview by Peter Yang with a designer who spends an equal amount of time in Figma and Claude Code

[https://www.youtube.com/live/x2LGggL6BNI?si=XdtCgCdQCntszDIo](https://www.youtube.com/live/x2LGggL6BNI?si=XdtCgCdQCntszDIo) is an intro by Meagan Choi into her experience as a designer for Claude Code (more of a basic intro than the above video)
