...
::: {.notes}
Picture from @Stackowiak2020, page 11. I've put the first three chapters of this book on Canvas. UT's interpretation of Fair Use permits three chapters of any book to be placed online.
:::
...
::: {.notes}
In some places they say Design, while in others, it's Develop---an interesting ambiguity, depending on how designers work with developers.
:::
...
::: {.notes}
How would you mitigate risk without hampering creativity?
:::
...
::: {.notes}
Each of these bullet points is a section in this slideshow.
:::
...
::: {.notes}
Bear in mind the title of Stackowiak's book, which includes AI solutions. Your mileage may vary.
:::
...
::: {.notes}
Why are there silos in the first place? Could it be that silos make a lot of work and allocation of responsibility tractable?
:::
...
::: {.notes}
The agenda is long but each item certainly does not get equal time. It's often said that planning a meeting requires approximately as much time as the meeting itself. Deciding how much time to allocate to each item could be a time-consuming task.
:::
...
::: {.notes}
One of the worst things that can happen during the workshop is for someone to say, "We have to check with person X about issue Y before we can proceed," meaning you don't have the right people in the workshop. If no one in the workshop has the authority to delegate time to design thinking activities, motivation will quickly dissipate.
:::
