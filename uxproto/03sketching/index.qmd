...
## A provocative talk
- Jenny Wen, formerly design director at Figma
- Leader of the Figjam team
- Talk: Don't trust the process
- [https://youtu.be/KyOMQJUxQ28?si=134azCPcFvb5Zd-Z](https://youtu.be/KyOMQJUxQ28?si=134azCPcFvb5Zd-Z)
- Refers to the double diamond process (the other major school of design thinking besides the Stanford school---think EDIPT, which is what we tried on day one)
- Says you should not rigidly adhere to the process, instead make a lot of prototypes
- Double diamond has four steps (she says it's five?!) but she advocates three, but even be flexible about those three
- Advocates brainstorming, sketching, and prototyping
...
[https://youtu.be/PmmQjLqJQlY?si=6evVXHwPHLSwxfEZ](https://youtu.be/PmmQjLqJQlY?si=6evVXHwPHLSwxfEZ)
