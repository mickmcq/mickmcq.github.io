---
title: "More on Techniques and System Prompts"
...
- Try the Python fragments from the tutorial on the seve-wonders dataset
- If that's successful, try it on your own dataset
- The fragments are *Check dataset validity*, *List configuration and splits*, *Preview a dataset*, *Download slices of a dataset*, *Search text in a dataset*, *Access Parquet files*, and *Get the size of the dataset*.
