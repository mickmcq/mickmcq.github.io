...
One of the blob files should be about 4.4GB. The file names are long hash keys and only matter if you think your download was corrupted.


# The chatbot
We now turn our attention to the `localRAGchatbot.qmd` file. You must download that file from Canvas, along with `Xiao2025.pdf`. This later file is a book, @Xiao2025.
