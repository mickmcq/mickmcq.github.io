...
You should deploy something you can put in your portfolio, but this can be anything from a simple chatbot like we created using `chatlas` or an agentic app using, say, Google's ADK. There needs to be extensive use of prompting and it needs to be possible to evaluate and compare prompts in your project.
