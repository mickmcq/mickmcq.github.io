...
- Most people included last names, which we discussed as a privacy no-no
- Many people included the boilerplate, which should have been removed
...
## You guessed it: the Anthropic settlement
- Is 1.5 billion dollars a lot?
- It's 3,000USD per book for 500,000 books
- Fair use books were exempted from the settlement---only books from LibGen were covered
- Current Anthropic valuation: 183 billion USD

## Other news
Let's look at Data Points and The Batch

## Last semester's news in week three: Deepseek R1
