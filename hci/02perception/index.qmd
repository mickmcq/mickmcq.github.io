...
- Q and A from last time (actually last semester)
- Example Article presentation (Mick)
- Groups
- Perception
- Perception Discussion (Victor)
- @Norman2023

# Q and A from last time
It didn't work! (There are two empty responses and nothing else!)

As a result, we'll look at last semester's Q&A.
...
$\langle$ pause for example article presentation by Mick $\rangle$
...
## Discussion of readings (led by Victor)
