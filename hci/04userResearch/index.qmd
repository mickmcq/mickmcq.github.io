...
- Discussion leading (Na Kyoung Jang)
- Design Critique (Yachun Huang)
- Article Presentation (?)
- Figma tutorial (Vaishnavi)
- Break
- User Research
- Readings
...
- "I have learned that our group project idea still has some problems, and I would like to think more about the planner topic. Or we may change the topic to find a better one. "
- "I did enjoy the history of the processes. It is interesting to see how we evolved from Baby Bubblehead."
- In the discussion we had regarding the mental models on how much time it would take for the user to get used to, I really learned a lot on with the examples fellow students came up with

## More learning
- I particularly enjoyed the conversation around data privacy and how design  can help maintain the same e.g. by giving bite-sized tips to users, letting them opt-in rather than opting them into the data sharing system by default, copyrighting and so on.
- The important point I have learned today is a good website should take into account a variety of factors, including usability, impossibility to build, etc.

## Still more learning
- I learned a lot from the discussion and the presentations today. Especially from the discussion where important examples, relevant to current design practices in industry were brought up. I also found the point around gmail removing the reply button quite fascinating. I have a follow up question around that, which is -
- It is important to look at the history of HCI research as related to human cognition because new work can be informed by past lessons / mistakes / shortcomings / realizations
- Cognition in UX and past studies and understanding in terms of laws, theory associated in it.

## Even more learning
- Dark patterns, intentionally bad design, and deceiving design was a very interesting conversation
- I appreciated the discussion and the examples shared by everyone; it made me reflect on the readings and think of other perspectives that I haven't thought of. My takeaways from the class was the ethical considerations that designers need to take into account; for example "making it hard" for people to unsubscribe, or unfollow etc.

## Questions
- I had a lot of questions about the group topics, so being able to discuss them openly in class was helpful. Also, moving the lecture to the end will help me remember my questions.
- Nothing much, looking forward for the next lecture
- I would like to know more about designing for privacy and also for parents who are wary of their children's online safety.

## More questions
- none
- How often does the world of design/design research get disrupted by a new company, product or service that introduces a popular feature which doesn't align with established design best practices? This is hypothetical, but I imagine there are certain brands or company models that disrupt the norm and require researchers to reorient or reassess established principles

## Even more questions
- Loved the discussion, it honestly helped me better remember and understand the readings. Definitely wished it was at the beginning of class, for time's sake and also from the perspective of the presenters. It would be nice to get it out of the way and focus on class.
- When talking about constraints, mainly legal, how do designers adjust to the different regulations (for example: GDPR vs. US) when the app/website is present in different countries? How do designers balance the uniformity of their designs while navigating these different constraints? 
