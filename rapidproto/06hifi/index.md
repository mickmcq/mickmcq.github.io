...
# But first ... Some feedback from Vaishnavi
...
1. All prototyping is rapid prototyping due to historical reasons
2. The notion "Lean UX Methodology" involves developers and designers integrating. That can't be done in a class of designers with no developers

## The course history
I inherited this course and have given you (mostly) the syllabus I received. I now see several reasons to go in a different direction.

All is not lost. I think we're studying the correct topics, just not in the correct order and with the correct weights.

## The topics so far (1 of 2)
- EDIPT: Empathize, Define, Ideate, Prototype, Test was our first topic. To some extent, I expect you to fall back on this design thinking process in preparing your protoypes for this class, although different design challenges are more amenable to certain steps than others.
- Techniques: story mapping, mood boards, sketching, crazy eights. I expect you to polish some of these techniques through design challenges.
- Clients: I expect you to simulate working with clients by, for instance, talking to a fifteen-year-old the way that person expects.

## The topics so far (2 of 2)
- Agile: I expect you to simulate working with developers in your design challenges
- Components of a hifi: Color, typography, layout, animation. I expect you to use these in your remaining hifi prototypes.

## The remaining topics
- Ideation: I want you to create lofi prototypes to generate discussion around alternatives
- Accessibility: I want you to factor accessibility into your prototypes
- Workshopping: I want you to figure out how to bring developers into the picture
- Testing: I want you to test your prototypes!
