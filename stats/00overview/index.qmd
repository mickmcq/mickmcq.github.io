...
- stats: "originated" with farming, trying to infer general knowledge from small samples

## Two things: frequentists and bayesians
- frequentists: believe that the frequency with which events happen IS the probability of events happening
- Bayesians: believe in incorporating prior knowledge into guesses about future events
...
## Two things: neutral data and discipline-specific data
- neutral data: textbook uses examples from non-IT disciplines
...
Fonts are *League Gothic* and *Stix*
